...
if __name__ == '__main__':
    ...
    while True:
        try:
            ...
            if coverage < 0 or coverage > 5:
                raise ValueError()
            break
        except ValueError:
            print("Error in input. I need real value from 0 to 5. Try again...")
    ...
    while True:
        try:
            ...
            if compare_alignments != 'y' or compare_alignments != 'n':
                raise ValueError()
            break
        except ValueError:
    ...
    if compare_alignments == 'y':
        compared_file_name = input("Please give me that filename.")
